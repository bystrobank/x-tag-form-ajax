...
(function () {
    ...
    xtag.addEvent(document, 'click:delegate(form[is=form-ajax] button[type=submit])', function (event) {
        var form=this.form;
    ...
    xtag.addEvent(document, 'submit:delegate(form[is=form-ajax])', function (event) {
